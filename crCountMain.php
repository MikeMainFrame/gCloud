<svg viewBox="0 0 4400 2800"  
  ...
  <defs>
    <link xmlns="http://www.w3.org/1999/xhtml" href="http://fonts.googleapis.com/css?family=Play" type="text/css" rel="stylesheet" /> 
    ...
    <pattern id="hatch03" patternUnits="userSpaceOnUse" x="0" y="0" width="25" height="25"  viewBox="0 0 25 25" >
		  <path d="M0,0 L25,25 M25,0 L0,25 "  fill="none" stroke="#003" stroke-width="5" />     
		</pattern>	
  </defs>
  
  <!--rect x="1" y="1" height="2800" width="4400" style="fill:url(#hatch03)" /-->
  
  <g id="buttons">
    <g font-size="48" fill="#ff6000"><path d="M1550,200 L2800,200 Q2850,200 2850,250 L2850,1800 Q2850,1850 2800,1850 L2400,1850 L2300,1750 L1650,1750 Q1550,1750 1550,1700 L1550,250 Q1550,200 1600,200 Z" fill="#00a" /></g>   
    <g font-size="48" fill="#666" letter-spacing="12"><text x="4300" y="200" transform="rotate(90, 4300,200)" text-anchor="start">SALES  STATISTIC  LEGAL  UNIT  33609353</text></g>        
    <g font-size="64" fill="#fff" text-anchor="middle" font-weight="100">    
      <text    x="1550" y="1840" text-anchor="start" fill="#888" id="zstatus">quo</text>
      <circle cx="1750" cy="2125" r="125" stroke-width="0" stroke="#0f0" fill="#0a0" zfactor="1" /><text x="1745" y="2140"  id="addsub" >add</text>                
      <circle cx="2200" cy="2125" r="125" stroke-width="3" stroke="#f00" fill="#f00" zdateselect="true"  />
        <use xlink:href="#icon-calendar" fill="#fff" x="2154" y="2080" height="96" width="96" zdateselect="true" />
